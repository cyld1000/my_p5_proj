...
function preload(){
  ...
  keyH = loadSound("Waves_0.mp3");
  keyF = loadSound("Waves_1.mp3");
  keyG = loadSound("Waves_2.mp3");
  keyL = loadSound("Waves_3.mp3");
  keyD = loadSound("Waves_4.mp3");
  keyK = loadSound("Waves_5.mp3");
  keyJ = loadSound("Waves_6.mp3");
